...
//goes to the given frame in the timeline of the instance and stops there;
overworldMc.kopeMc.gotoAndStop("kopeStandFront");
// kobe is the part of background;
// variables for link
...
function gameLoop(loopEvent:Event):void
{
	...
	if (linkMc.hitTestObject(overworldMc.kopeMc))
	{// tests the two characters if they have collided or not
